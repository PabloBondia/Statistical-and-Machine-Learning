...
set.seed(0)
# Convert data to matrix format (excluding intercept column)
...
# Convert data into XGBoost DMatrix format (faster and optimized)
...
tune_grid <- expand.grid(
  nrounds = c(100),         # Reduce to 2 values
  eta = c(0.05, 0.1),           # Fewer values
  max_depth = c(6),          # Shallower trees
  gamma = c(0.1),            
